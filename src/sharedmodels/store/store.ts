...
export const printerAvailable: ActionReducer<boolean> = (state: boolean = false, action: Action) => {
  switch (action.type) {
    case 'SET_PRINTER_AVAILABLE':
      return action.payload;
    default:
      return state;
  }
...
export const flyingChangesPossible: ActionReducer<boolean> = (state: boolean = false, action: Action) => {
  switch (action.type) {
    case 'SET_FLYINGCHANGES_POSSIBLE':
      return action.payload;
    default:
      return state;
  }
...
export const selectedAudiofile: ActionReducer<Audiofile> = (state: Audiofile = new Audiofile(), action: Action) => {
  switch (action.type) {
 ...
 */
export const selectedStandpunkte: ActionReducer<Position[]> = (state: Position[], action: Action) => {
  switch (action.type) {
